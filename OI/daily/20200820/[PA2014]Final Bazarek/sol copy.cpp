...
int main() {
    ...
    // printf("\n");
    // for(int i = 1; i <= n; ++i) printf("%lld ", lodd[i]);
    // printf("\n");
    // for(int i = 1; i <= n; ++i) printf("%lld ", rodd[i]);
    // printf("\n");
    // for(int i = 1; i <= n; ++i) printf("%lld ", leven[i]);
    // printf("\n");
    // for(int i = 1; i <= n; ++i) printf("%lld ", reven[i]);
    // printf("\n");
    scanf("%d", &m);
    while(m--) {
        scanf("%d", &k);
